...
/// {@endtemplate}
class MaybeMapTemplate extends TemplateCore<_MaybeMapItem> {
  ...
  @override
  Iterable<_MaybeMapItem> get configFields =>
      fields.map((field) => _MaybeMapItem(enumName, field));
}

class _MaybeMapItem extends ItemCore {
